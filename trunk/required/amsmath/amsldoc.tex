...
\item[\opt{alignedleftspaceyesifnef}]
\end{description}
...
was typically corrected by prefixing the environments with \cn{\!}.
...
\item[\opt{alignedleftspaceyesifnef}] Only add \cn{\,} if the environment is prefixed by negative space. (New default behaviour.)
\end{description}
