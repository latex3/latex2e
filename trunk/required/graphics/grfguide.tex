...
Standard versions of the configration files are maintained by the
\LaTeX\ project and distribute in the CTAN |graphics-cfg| collection.

For special requirements you may edit these |cfg| files
to set up a site default for these options. Suppose that you wish for
