...
documentation of multi\-lingual support, and avoiding errors in
...
to \verb|\mathchardef| in Lua\TeX. \NOTDONE
...
that \verb|\times \dots \times| will use centred dots with
...
packages has required updates to the configuration files to select a
...
directly in the \TeX Live svn, and were not available on CTAN.)
\end{document}
