...
\paragraph{Inclusion of Latin Modern and \TeX\ Gyre font subsets}
...
\paragraph{Edge case improvement in \texttt{xspace}}

% from memory, "\emph{\foo}" now doesn't insert a space when it did before
  ...
  \def\expandafter\expandafter\expandafter
    #1\expandafter\expandafter\expandafter
       {\expandafter\expandafter\expandafter
         ...
         \@nil}%
\end{verbatim}
Code like this nicely the limitations in the programming layer of \LaTeXe{} and the advantages that  \textsf{expl3} will offer on this level.
