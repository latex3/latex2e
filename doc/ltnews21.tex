...
The \textsf{graphicx} version of \verb|\rotatebox| now allows ``long'' to allow \verb|\par| (and blank lines)
in values to match the change to the `\textsf{graphics} version some years ago. See graphics/4296.
