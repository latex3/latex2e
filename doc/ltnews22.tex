...
functionality will it adjust its version to that matching the
requested \LaTeX{} release date. Initially this will only be true for
a few selected package an in all honesty it may not be suitable for packages
that have their own release cycles and methods.

Thus, to regenerate a document with 100\% compatible behvior
