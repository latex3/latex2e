...
If one writes \verb=$ a \to \dots \to b $= the result is $ a \to \dotsb
%
% use \bdots if unicode-math is used because that has a bug!
%
...
and you have to use \cs{dotsb} to get the binary dots back. This has
