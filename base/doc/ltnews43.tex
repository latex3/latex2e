...
Internally, some text constructs in \LaTeX{} have used math mode internally, as
...
multiple math font dimensions.} For new documents, we suggest setting to a
predictable offset based on text font dimensions (for example a fixed
percentage of the x-height).
...
(based on feedback and experience with it use) might change over over time. In
