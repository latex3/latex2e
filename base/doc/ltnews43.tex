...
addressed a long-standing technical wrinkle: (miss)using math mode simply to align
...
caused concerns so now the fallback is again applied silently.
%
\taggingissue{1115}
...
among other things consolidated the key names which have been
...
In this release we provide a first implementation of heading comments
...
limited reimplementation of \cs{secdef}. This will help and making
