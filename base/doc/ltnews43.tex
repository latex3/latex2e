...
We now extended this support and load additionally a file 
...
of symbol fonts we load and activate the files also with this engine if PDF mode 
...
allow package for symbol fonts to use the commands without testing the 
engines first. 
%
\githubissue{2007}
