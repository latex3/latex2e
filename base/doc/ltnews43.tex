...
This was due to an inconsistency in the environment's internal measurement
phase, which has now been corrected.

As a result, more material might fit on a page potentially changing the
pagination. If that happens, an explict \cs{pagebreak} will restore the
