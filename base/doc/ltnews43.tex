...
\section{Change to the \pkg{doc} package}

Resolved the errors under \hologo{upTeX}. Using \cs{normalfont} instead of
\cs{rmfamily} when setting the length \cs{MacroIndent}.
