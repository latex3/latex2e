...
\subsection{\pkg{varioref}: Upaded default string for Hungarian}

The text string for Hungerian have been corrected. At the same time an
addition option was added to select them, i.e., it is now possible to
