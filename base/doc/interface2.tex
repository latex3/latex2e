...
\subsubsection{Manipulating \TeX{}-level registers}
...
\begin{function}[]
  ...
  \begin{syntax}
    \cs{@namedef}\Arg{name}\meta{arg-spec}\Arg{code}
  \end{syntax}
...
\begin{function}[]
  ...
  \end{syntax}
  Swallow one to four arguments (or individual tokens) and do nothing with them.
\end{function}



\subsubsection{Catcode manipulations}
...
\begin{function}[user]
  ...
  \begin{syntax}
    \cs{makeatletter} \meta{material} \cs{makeatother}
  \end{syntax}
...
\begin{function}[int]
  ...
  Internal macro implementing \cs{@dblarg}.
\end{function}
...
\subsubsection{Saving space (and processing time)}
...
\begin{function}[int]
  ...
  Internal macros implementing \cs{typein}.
\end{function}
...
\begin{function}[]
  ...
  \begin{syntax}
    \cs{@onlypreamble}\cs{\meta{cmd}}
  \end{syntax}
  Saves \cs{\meta{cmd}} in a list of commands to be disabled at begin
  of document.
\end{function}
...
\begin{function}[]
  ...
  \begin{syntax}
    \cs{@preamblecmds}
  \end{syntax}
  Place where \cs{@preamblecmds} stores commands for
  disabling. Running this command will disable the commands.
\end{function}
