...
\subsection{Document meta font families}
...
none of the meta families but some other font family is currently used).

As one application of this there is \cs{@restoremetafamily}. If the
current meta family is \meta{name} it executes \cs{\meta{name}family},
...
\subsection{Font series defaults per document meta family}
