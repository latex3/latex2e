...
text following the environment is expected to belong to the corrent
...
In some situation or for some types of block environments (such as
...
implicit \cs{par} commands mimiking the effect of explicit empty lines
in the source.

We took the opportunity to also fix a couple of subtle problem with
the mechanism so that it hopefully works better a few unusual
situations.
%
