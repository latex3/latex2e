...
Until now heading structures used a mix of PDF tags (\texttt{Sect), \textt{Span}} and tags from the \LaTeX{} name space (\texttt{section}, \texttt{section-number}). This has now been consolidated and the \LaTeX{} name space is used for all heading structure tags.
