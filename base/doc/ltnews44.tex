...
\subsection{Fixed issue with \hook{env/\meta{math env}/end}}

Due to an issue in the definition of \cs{math_register_env:nn}, adding to the \hook{env/\meta{math env}/end}
