...
Due to an issue in the definition of \cs{math_register_env:nn}, adding to the \hook{env/\meta{env}/end}
hook for a math environment such as \env{equation} produced an error.
The definition of \cs{math_register_env:nn} has been fixed and made equivalent to what was previously
called \cs{math_register_halign_env:nn}. The latter command has been removed.
%
\taggingissue{1603}
