...
\cs{DeclareTemplateCode}, such that you can use \cs{UseName} here without any
...
numerals. Of course, such variables then also need to be referred to via \cs{UseName} or some equivalent method in the code, so this is only useful if there is a pressing need for such special names.
