...
There are still some open points, e.g., frames are not perfectly tagged, when escaping to math the math is not tagged; when using braces to delimit the argument of \cs{lstinline} there is no tagging, but for most standard uses it is now possible to use the package-
%
