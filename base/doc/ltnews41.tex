...
Moreover, 
the PDF tagging structures 
have to be added somewhere in the middle of that
...
\TeX{} coding\Dash in \file{latex-lab-math.pdf} for the interested.

When using \LuaTeX{} the situation is much improved because the necessary 
extra structures can be added later, i.e., when
