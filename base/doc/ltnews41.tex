...
Due to the complexity of getting tagging code injected in a display
formula, it was initially not possible to locally change
\cs{belowdisplayskip}, \cs{belowshortdisplayskip}, or
\cs{postdisplaypenalty} on a per formula basis. We have now slightly
altered the method making such user adjustments possible again.
%
\taggingissue{809}
