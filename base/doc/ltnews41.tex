...
display not only the last right-mark (\cs{rightmark} or
...
describing their content in an \texttt{alt} attribute.\marginpar{added is this correct like that Ulrike?}
%
