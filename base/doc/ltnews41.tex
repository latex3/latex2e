...
For this reason there are now the sockets
\socket{build/column/footnotes/baselineattach} and
\socket{build/column/floats/baselineattach}. The can be assigned the
plug \plug{on} in which case the attachment of footnotes/floats is
measured from the baseline of the last text line. To mimic the
