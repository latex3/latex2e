...
Our first attempt in doing that was slightly faulty and, in some
cases, resulted in the addition of an incorrect \cs{parskip} space.
This has now corrected and the gymnastics to achieve this are rather
an \enquote{interesting} study in obfuscated \TeX{} coding\Dash in
