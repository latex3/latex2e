...
\section{Changes to files in \pkg{expl3}}

Work on \pkg{expl3} continues in parallel with development of the \LaTeX{}
kernel. Of note for developers is that we have integrated more code into the
main \pkg{l3kernel} bundle, and therefore into the functionality available
automatically within \LaTeX{}. Most notably, \pkg{l3benchmark}, which provides
tools for checking code performance, is now part of \pkg{l3kernel}.
