...
end command. By adding these \cs{providecommand} lines in the package or
class, this then works also with older \LaTeX{} kernels.
...
to attach \TeX{} code for tagging to such displayed formulas whilst ensuring that such code
...
one-off \cs{belowdisplayskip} setting inside the formula. We have now
