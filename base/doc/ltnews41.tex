...
The reason we recommend setting the value relative to the default is that to
get the same behavior across all engines, a different absolute value of
\cs{tracinglostchars} is needed. This relates to how lost characters inside
boxes are handled, where Lua\TeX{} takes a different approach to other engines.
