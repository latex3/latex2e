...
added two new allocators \cs{newluacmd} and \cs{newprotectedluacmd} which
directly define control sequences invoking the allocated Lua functions.
The former defines an expandable Lua command, the latter a protected
