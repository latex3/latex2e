...
\texttt{f}~specification. This means that when the optional argument is absent,
...
For technical reasons, we recommend that spaces are ignored when searching for
an optional argument before an \texttt{f} specification: this can be achieved
by adding the \texttt{!} modifier as showing in the example. However, this is
left as a choice for the user.
