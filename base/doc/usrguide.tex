...
If the argument is completely blank or is a brace group which is blank, the
conversion results in an empty keyval list, not \verb*|short-text = |. This is the
desired outcome in almost all cases.
