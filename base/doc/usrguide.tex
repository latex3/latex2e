...
stored as active characters. In $8$-bit engines and non-ASCII characters are
active, whilst other than the letters a--zA--Z, ASCII characters are
...
from Unicode data. As such, token-based comparisons are likely to fail unless
set up properly.
