...
When the \LaTeX{} is rolled back to date \meta{date1} and a class or
package with minimum date requirement \meta{date2} is to be loaded, if
\meta{date2} is later than \meta{date1}, a rollback warning is raised:
\begin{verbatim}
...
Before, wrong file type may be used in this message, for example
