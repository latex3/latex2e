...
commands were used only in vertical mode, but with \LaTeX2e in 1994,
we changed the internals but simply overlooked that this error became
useless already then. In this release, i.e. 30 years too late we have
finally lifted the ban and from now on this error should now only show
