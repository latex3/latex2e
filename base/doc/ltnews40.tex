...
many drivers for this work, but include legal changes in many places which will
increasing require well-tagged PDFs including full support for mathematics. As
part of the work on this, we are looking at the technical abilities of the
\TeX{} engines.

With for \XeTeX{}, it is impossible to reliably produce tagged PDFs due to
...
However, it is likely that over time functionality may become more restricted.

For \pdfTeX{}, tagging is available and we are able to support mathematics by
including \TeX{} mathematical sources or by using externally-generated MathML.
Only \LuaTeX{} is capable of \emph{automatic} generation of MathML as part of a
\LaTeX{} run. Thus \pdfTeX{} continues to be fully supported, but for new
...
\LaTeX{}, a new switch |--dev| has been added to \pkg{l3build}.
