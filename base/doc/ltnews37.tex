...
\section{New functionality offered by the \enquote{\LaTeX{} Tagged PDF} project}

We have now enabled new automatic tagging functionality for additional
\LaTeX{} elements, among them most display environments, standard sectioning
commands and content, figure and table listings. This can be activated through
\begin{verbatim}
...
described in the \LaTeX{} manual that do not have tagging support
yet, notably tabulars, floats, \texttt{tabbing} and various math environment. 
They will get this support as part of \texttt{phase-III} between
now and the June release.

The \texttt{latex-lab} bundle contains various 
(still untagged) documentation file about the new code that can
be accessed with \verb|texdoc -l latex-lab|.

Feedback is welcome! 
Please use https://github.com/latex3/latex2e/discussions %adapt link
