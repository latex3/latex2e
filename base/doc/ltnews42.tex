...
\verb+\declare@scriptfont@mapping+ has been added. It can be called with two
font family names to indicate that whenever the first family is selected as a
math font, the second should be used as a script font.
%
\githubissue{1707}
