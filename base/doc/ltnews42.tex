...
\LaTeXe{}, while others are very widely used in up-to-date documents (for
example \pkg{array}). We have marked a small number of packages in \pkg{tools}
as retained for historical and stability reasons, and where relevant pointed
to more up-to-date alternatives:
\begin{itemize}
