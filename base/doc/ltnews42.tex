...
To model such \enquote{big paragraphs} \LaTeX{} uses a structure named 
...
\enquote{big paragraphs}, so with this release we moved the relevant tagging 
code into sockets. The \enquote{big paragraphs} can now be disabled by 
...
named \texttt{Gin/alt}, \texttt{Gin/actualtext}, and \texttt{Gin/artifact}. 
