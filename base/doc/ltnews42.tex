...
\subsection{Update the \cs{theH\meta{counter}} representation in \cs{counterwithout}}

In the November 2024 release~\cite{42:ltnews40}, we added the
\cs{theH\meta{counter}} counter representation for link targets to the
kernel. So far the new representation is defined by \cs{newcounter} and
may be updated by \cs{counterwithin}, along with the \cs{the<counter>}.
But \cs{counterwithout} was missing from the party, which didn't update
the new representation. This has now been corrected.
%
\githubissue{1829}
...
\bibitem{42:ltnews40} \LaTeX{} Project Team.
