...
\begin{center}
  \small\ttfamily
  % Tagging 2026-09-12: make arrows artifacts
  % unrelated: correct formatting of left column
  % header declaration
  \tagpdfsetup{table/header-rows=1}
  \begin{tabular}{l@{\SuspendTagging{}$\;\rightarrow\;$\ResumeTagging{}}l}
    \hline
    \rmfamily Old name         & \rmfamily New name \\
    \hline
...
with this declaration you can alter the default for individual font
metafamilies by, for example, changing the bold setting only for the
...
for all metafamilies in one go. This alteration cannot be done when the
