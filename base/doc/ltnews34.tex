...
%%  We think that "discovered" was wrong here.  
%%  Also acceptable would be:   uncovered  
...
%% Chris thinks this looked better before, with the line breaks.  But OK.
ones like
\verb|env/|\meta{name}\verb|/after|, 
with the variable, \meta{name}, part
%% This either needs parentheses (or commas). 
%% Or possibly better to make it longer, as here:
%%    with the variable part, \meta{name} in this case,
...
%  \\ \mbox{}\qquad ?  Agreed: Better without this. 
