...
%%CCC discovered is simply wrong! inanimate thimgs cannot perform
%%     thoughtful acts such as discovery! 
%%    "uncovered" would be OK too.
a small number of 
...
%% CCC Not sure about this, I think it looked better before.  But OK.
ones like
\verb|env/|\meta{name}\verb|/after|, 
with the variable 
%z CCC this either needs parentheses (or commas) or leave it out.
%%   \meta{name}
...
%  \\ \mbox{}\qquad ?  CCC Agreed: Better wothout this. 
