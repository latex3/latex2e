...
\DeclareTextCommandDefault{\textestimated}      {\tc@check@symbol6\textestimated}
\DeclareTextCommandDefault{\textnumero}         {\tc@check@symbol6\textnumero}
...
\DeclareEncodingSubset{TS1}{lato-*}                   {0}
\DeclareEncodingSubset{TS1}{opensans-*}               {0}
\DeclareEncodingSubset{TS1}{tli}                      {0}
\DeclareEncodingSubset{TS1}{cantarell-*}              {0}
