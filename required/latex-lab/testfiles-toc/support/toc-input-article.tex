...
\IfDocumentMetadataT{\UseTaggingSocket{sec/end}{-1} %close section
...
\IfDocumentMetadataT{\UseTaggingSocket{sec/end}{-1}} % end part

\newpage

\IfDocumentMetadataT\UseTaggingSocket{sec/begin}{{-1}{}}
\refstepcounter{part}
...
\IfDocumentMetadataT{\UseTaggingSocket{sec/end}{-1}} 
