...
|[t]|\index{t option@\texttt{t} (top) option} or
|[b]|\index{b option@\texttt{b} (bottom) option} argument to specify vertical
...
is intended for use when the interjected text is only a few words; this
...
The \nipkg{amsmath} package provides also a \env{subequations}
environment\index{equationn@equation numbers!subordinate numbering} to make it
...
\mail{tech-support@ams.org}.  This software is also posted on CTAN
